...
export default function Flight({ flight, airports }) {
  ...
  return (
    <div className="container-fluid">
      <div className="row">
        <div className="col-md-2">{flight.departure.iata}</div>
        <div className="col-md-8">{flight.flight_date}</div>
        <div className="col-md-2">{flight.arrival.iata}</div>
      </div>
      <div className="row">
        <div className="col-md-3"> {depCity}</div>
        <div className="col-md-3">
          {convertDate(flight.departure.scheduled)}
        </div>
        <div className="col-md-3"> {arrCity}</div>
        <div className="col-md-3">{convertDate(flight.arrival.scheduled)}</div>
      </div>
      <div className="row">
